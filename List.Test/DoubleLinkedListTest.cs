...
namespace List.Test
{
    public class DoubleLinkedListTest
    {
        ...
        {
            DoubleLinkedList<int> V = new DoubleLinkedList<int>(a);
        ...
        public void Find(int[] actualArr, int value, int expectedIndex)
        {
            ...
            DoubleLinkedList<int> actualList = new DoubleLinkedList<int>(actualArr);
        ...
        public void Sort(int[] actualArr, int numExpectedMoq)
        {
            DoubleLinkedList<int> expected = DoubleLinkedListMoq(numExpectedMoq);
            DoubleLinkedList<int> actual = new DoubleLinkedList<int>(actualArr);
            actual.Sort(actual._root, actual.GetNode(actual._length - 1), actual._length);
        ...
        {
            DoubleLinkedList<int> list = DoubleLinkedListMoq(numMoq);
